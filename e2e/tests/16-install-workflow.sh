...
echo "[16/21] Install GitHub Workflow"
...
echo "" | git-prompt-story install-github-workflow
...
echo "y" | git-prompt-story install-github-workflow
...
echo "  All install-github-workflow tests passed"
